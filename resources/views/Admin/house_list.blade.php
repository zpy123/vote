...
<div class="page-header">
	<h1>
		...
		<small>
			...
			<a href="{{url('houseadd')}}"><button class="btn btn-info">添加房型</button></a>
		</small>
	</h1>
</div><!-- /.page-header -->
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="table-responsive">
					<table id="sample-table-1" class="table table-striped table-bordered table-hover">
						...
						@foreach($arr as $v)
							...
							<tr>
								...
								<td>{{$v['rt_price']}}</td>
								<td>{{$v['rt_count']}}</td>
								<td><img src="storage//uploads/{{$v['rt_img']}}" alt="" width="40px" height="40px"/></td>
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
										...
										<a href="{{url('update')}}?rt_id={{$v['rt_id']}}">
										<button class="btn btn-xs btn-info">
											<i class="icon-edit bigger-120"></i>
										</button></a>

										<a href="{{url('delete')}}?rt_id={{$v['rt_id']}}">
					...
					<center><?php echo $arr->render(); ?></center>
