											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												@foreach($arr as $k => $v)
													<tr>
														...
														<td>￥{{$v['o_price']}}</td>
														<td class="hidden-480">{{$v['o_pubname']}}</td>
														<td>{{$v['o_typename']}}</td>
														...
														@elseif($v['o_status'] == 1)
															<span class="label label-sm label-warning">待消费</span>
														@elseif($v['o_status'] == 2)
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<button class="btn btn-xs btn-danger" onclick="puborder_del({{$v['o_id']}})">
...
<![endif]-->
		...
		<script>
			// 删除订单
			function puborder_del (id) {
				$.get("{{url('myadmin/PubOrderDel')}}",{'o_id':id},function (msg) {
					$("#html").html(msg);
				});
			}
		</script>
