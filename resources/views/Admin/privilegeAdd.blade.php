	...
	<body>
								...
								<form class="form-horizontal"   role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 权限名称  </label>
                                                                                <div class="col-sm-9">
											<input type="text"  id="pri_name"   placeholder="privilegename" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 父级权限 </label>
                                                                                <div>
										<select class="" style="margin-left:12px;" id="pri_fid"  >
										...
										<div class="col-sm-9">
											<input type="text" id="pri_route"  placeholder="routename" class="col-xs-10 col-sm-5" />
										</div>
		...
		$("#sub").click(function(){
			...
			if(pri_name == '' || pri_route == ''){
				...
				$.get('privilegeAdd',{'pri_name':pri_name,'pri_fid':pri_fid,'pri_route':pri_route},function(msg){
					if (msg==1) {
						alert('权限添加完成');
					}else{
						alert('该权限已存在，请重新添加。');
