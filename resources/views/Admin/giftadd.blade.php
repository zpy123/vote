...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{asset('')}}Admin/css/jquery-ui-1.10.3.custom.min.css" />
		<link rel="stylesheet" href="{{asset('')}}Admin/css/chosen.css" />
		<link rel="stylesheet" href="{{asset('')}}Admin/css/datepicker.css" />
		<link rel="stylesheet" href="{{asset('')}}Admin/css/bootstrap-timepicker.css" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="{{url('Gift')}}" enctype="multipart/form-data" method="post">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼品名称： </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="g_name" placeholder="请输入礼品名称" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 兑换积分： </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="g_point" placeholder="请输入兑换积分" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 礼品图片： </label>

                                        <div class="col-sm-9">
                                            <input type="file" id="form-field-2" name="g_img"/>
                                        </div>
                                    </div>
