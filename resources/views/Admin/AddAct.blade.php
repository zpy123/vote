...
<head>
    ...
    <link rel="stylesheet" href="{{url('Admin/css/jquery-ui-1.10.3.custom.min.css')}}" />
    <link rel="stylesheet" href="{{url('Admin/css/chosen.css')}}" />
    <link rel="stylesheet" href="{{url('Admin/css/datepicker.css')}}" />
    <link rel="stylesheet" href="{{url('Admin/css/bootstrap-timepicker.css')}}" />
    ...
    <script type="text/javascript" src="{{url('Admin/js/adddate.js')}}" ></script>
...
<form class="form-horizontal" role="form" action="{{url('InsertAct')}}" method="post" enctype="multipart/form-data">
    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 活动名称 </label>

        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" name="act_name"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-2"  class="col-xs-10 col-sm-5" name="act_content"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" name="act_stime" value="" id="" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')"/>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-4">结束时间</label>

        <div class="col-sm-9">
            <input type="text" name="act_etime" value="" id="" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')"/>
            <div class="space-2"></div>
        </div>
    </div>

    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-5">活动主题封面</label>

        <div class="col-sm-9">
            <div class="clearfix">
                <input class="col-xs-1" type="file" id="form-field-5" placeholder=".col-xs-1" name="act_img"/>
            </div>
...
<script src="{{url('Admin/js/jquery-ui-1.10.3.custom.min.js')}}"></script>
<script src="{{url('Admin/js/jquery.ui.touch-punch.min.js')}}"></script>
<script src="{{url('Admin/js/chosen.jquery.min.js')}}"></script>
<script src="{{url('Admin/js/fuelux/fuelux.spinner.min.js')}}"></script>
<script src="{{url('Admin/js/date-time/bootstrap-datepicker.min.js')}}"></script>
<script src="{{url('Admin/js/date-time/bootstrap-timepicker.min.js')}}"></script>
<script src="{{url('Admin/js/date-time/moment.min.js')}}"></script>
<script src="{{url('Admin/js/date-time/daterangepicker.min.js')}}"></script>
...
<script src="{{url('Admin/js/jquery.inputlimiter.1.3.1.min.js')}}"></script>
<script src="{{url('Admin/js/jquery.maskedinput.min.js')}}"></script>
<script src="{{url('Admin/js/bootstrap-tag.min.js')}}"></script>
