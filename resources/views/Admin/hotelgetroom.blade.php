					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="hotelgetroom" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 酒店名称</label>

										<div class="col-sm-9">
											<input class="col-xs-10 col-sm-5" type="text" id="form-field-7" placeholder="{{$arr['pub_name']}}" />
											<input type="hidden" name="pub_id" value="{{$arr['pub_id']}}" >
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 酒店房型 </label>

										<div class="col-sm-9">
										@foreach($ar as $v)
											<input type="checkbox" name="rid[]" value="{{$v['rt_id']}}">{{$v['rt_name']}}<br/>
										@endforeach
										</div>
									</div>
