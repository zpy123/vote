                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    ...
                                    @foreach($re as $v)
                                        <tr>
                                            ...
                                            <td>{{$v['act_name']}}</td>
                                            <td class="hidden-480">{{$v['act_content']}}</td>
                                            <td>{{$v['act_stime']}}</td>
                                            <td>{{$v['act_etime']}}</td>
                                            <td><img src="{{url($v['act_img'])}}" alt="" width="80px" height="80px"/></td>
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <button class="btn btn-xs btn-danger" onclick="delact({{$v['act_id']}})">
...
<script>
    ...
    function delact(act_id){
        $.get("{{url('myadmin/DelAct')}}",{'act_id':act_id},function(msg){
            $("#html").html(msg);
        });
    }
</script>
