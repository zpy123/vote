													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<button class="btn btn-xs btn-warning"   onclick="delrole({{ $v['pri_id'] }})">
																	删除权限
																</button>
															</div>
														</td>
...
<script type="text/javascript">
	function delrole(pri_id){
		if(!confirm("确认要删除？")){
  				window.event.returnValue = false;
			 }
		$.get('privilegeDel',{'pri_id':pri_id},function(msg){
			if(msg){
				window.location.href='privilegeList';
			}
		});
	}
</script>
