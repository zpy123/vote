        ...
        .result {
            ...
            text-align: left;
				...
				<li>
                   ...
                   <div class="citybox">
                      ...
                      <select name="region" name="" style="text-align:center">
                               @foreach($arr as $v)
                              <option id="cityid" value="{{ $v['county_name'] }}">{{ $v['city_name'] }}</option>
                              @endforeach
                      </select>
			...
			<li>
					<div class="coupon-nav coupon-nav-style">
					    ...
					    <span class="coupon-input" id="startdate"><a id="datestart" class="datebox" href="javascript:void(0)"><span class="ui-icon-down"></span></a></span>
					</div>
                  ...
                  <li>
					<div class="coupon-nav coupon-nav-style">
					    ...
					    <span class="coupon-input" id="enddate"><a id="dateend"  class="datebox"  href="javascript:void(0)"><span class="ui-icon-down"></span></a></span>
					</div>
                 ...
                 <input id="checkInDate" name="checkInDate" value="2016-01-11"  type="hidden" />
                 <input id="checkOutDate" name="checkOutDate" value="2016-12-12"  type="hidden" />
                 <input id="cityID" name="cityID" value="0" type="hidden" />
<script type="text/javascript">
    (function ($, undefined) {
        $(function () {//dom ready
            var open = null, today = new Date();
            var beginday = '2016-01-11';
            var endday = '2016-12-12';
            //设置开始时间为今天
...
<button type="submit" name="button" class="btn-large green button width80" >立即查找</button></div>
  <div class="control-group tc">
